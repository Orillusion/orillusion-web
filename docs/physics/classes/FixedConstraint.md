...
Defined in: [packages/physics/constraint/FixedConstraint.ts:8](https://github.com/orillusion/orillusion/blob/main/packages/physics/constraint/FixedConstraint.ts#L8)

Fixed constraint

## Extends

- `ConstraintBase`\<[`btFixedConstraint`](../@orillusion/namespaces/Ammo/classes/btFixedConstraint.md)\>

## Constructors

### Constructor

> **new FixedConstraint**(): `FixedConstraint`
...
> **wait**(): `Promise`\<[`btFixedConstraint`](../@orillusion/namespaces/Ammo/classes/btFixedConstraint.md)\>
...
`Promise`\<[`btFixedConstraint`](../@orillusion/namespaces/Ammo/classes/btFixedConstraint.md)\>
...
> **resetConstraint**(): `Promise`\<[`btFixedConstraint`](../@orillusion/namespaces/Ammo/classes/btFixedConstraint.md)\>
