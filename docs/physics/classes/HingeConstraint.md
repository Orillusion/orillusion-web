...
Defined in: [packages/physics/constraint/HingeConstraint.ts:9](https://github.com/orillusion/orillusion/blob/main/packages/physics/constraint/HingeConstraint.ts#L9)

Hinge constraint.

## Extends

- `ConstraintBase`\<[`btHingeConstraint`](../@orillusion/namespaces/Ammo/classes/btHingeConstraint.md)\>
...
Defined in: [packages/physics/constraint/HingeConstraint.ts:14](https://github.com/orillusion/orillusion/blob/main/packages/physics/constraint/HingeConstraint.ts#L14)
...
Defined in: [packages/physics/constraint/HingeConstraint.ts:19](https://github.com/orillusion/orillusion/blob/main/packages/physics/constraint/HingeConstraint.ts#L19)
...
Defined in: [packages/physics/constraint/HingeConstraint.ts:24](https://github.com/orillusion/orillusion/blob/main/packages/physics/constraint/HingeConstraint.ts#L24)
...
Defined in: [packages/physics/constraint/HingeConstraint.ts:30](https://github.com/orillusion/orillusion/blob/main/packages/physics/constraint/HingeConstraint.ts#L30)
...
Defined in: [packages/physics/constraint/HingeConstraint.ts:38](https://github.com/orillusion/orillusion/blob/main/packages/physics/constraint/HingeConstraint.ts#L38)
...
Defined in: [packages/physics/constraint/HingeConstraint.ts:42](https://github.com/orillusion/orillusion/blob/main/packages/physics/constraint/HingeConstraint.ts#L42)
...
> **wait**(): `Promise`\<[`btHingeConstraint`](../@orillusion/namespaces/Ammo/classes/btHingeConstraint.md)\>
...
`Promise`\<[`btHingeConstraint`](../@orillusion/namespaces/Ammo/classes/btHingeConstraint.md)\>
...
> **resetConstraint**(): `Promise`\<[`btHingeConstraint`](../@orillusion/namespaces/Ammo/classes/btHingeConstraint.md)\>
...
Defined in: [packages/physics/constraint/HingeConstraint.ts:52](https://github.com/orillusion/orillusion/blob/main/packages/physics/constraint/HingeConstraint.ts#L52)
...
The minimum hinge angle (lower limit).

##### high

`number`

The maximum hinge angle (upper limit).

##### softness

`number`

Softness coefficient indicating how soft the limit is. In the range 0 to 1; 1 means fully rigid.

##### biasFactor

`number`

Bias factor controlling the strength of the limit's restoring force. Typically in the range 0 to 1.

##### relaxationFactor?

`number`

(Optional) Relaxation factor controlling how quickly the limit recovers. Larger values mean faster recovery.
...
Defined in: [packages/physics/constraint/HingeConstraint.ts:63](https://github.com/orillusion/orillusion/blob/main/packages/physics/constraint/HingeConstraint.ts#L63)
...
Whether to enable the motor.

##### targetVelocity

`number`

The motor's target velocity.

##### maxMotorImpulse

`number`

The motor's maximum impulse.
