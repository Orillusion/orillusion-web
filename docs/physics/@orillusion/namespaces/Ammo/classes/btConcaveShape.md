...
Defined in: [packages/ammo/ammo.d.ts:408](https://github.com/orillusion/orillusion/blob/main/packages/ammo/ammo.d.ts#L408)
...
- [`btEmptyShape`](btEmptyShape.md)
- [`btStaticPlaneShape`](btStaticPlaneShape.md)
- [`btTriangleMeshShape`](btTriangleMeshShape.md)
- [`btHeightfieldTerrainShape`](btHeightfieldTerrainShape.md)

## Constructors

### Constructor

> **new btConcaveShape**(): `btConcaveShape`
