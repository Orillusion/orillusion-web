...
class Sample_GI {
    ...
    async run() {
        ...
        // let atodir = this.Ori.addFolder("AtmosphericSky");
        // atodir.add(atmosphericSky, 'sunX', 0, 1, 0.01);
        // atodir.add(atmosphericSky, 'sunY', 0.4, 1.6, 0.01);
        // atodir.add(atmosphericSky, 'eyePos', 0, 5000, 1);
        // atodir.add(atmosphericSky, 'sunRadius', 0, 1000, 0.01);
        // atodir.add(atmosphericSky, 'sunRadiance', 0, 100, 0.01);
        // atodir.add(atmosphericSky, 'sunBrightness', 0, 10, 0.01);
        // atodir.add(atmosphericSky, 'exposure', 0, 2, 0.01);
        // atodir.add(atmosphericSky, 'displaySun', 0, 1, 0.01);
        // atodir.add(atmosphericSky, 'enable');
        // atodir.open();
