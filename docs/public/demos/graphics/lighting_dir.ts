import { BoxGeometry, Camera3D, Engine3D, AtmosphericComponent, LitMaterial, HoverCameraController, MeshRenderer, Object3D, Scene3D, DirectLight, Vector3, View3D } from '@orillusion/core';
...
class Sample_Light {
    ...
    async run() {
        ...
        mainCamera.perspective(37, this.engine.aspect, 1, 10000.0);
