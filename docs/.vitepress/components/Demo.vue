<template>
    <div class="demo" :class="{
        ...
        <span class="toggle" title="Fullscreen" @click="fullscrren()" :style="{'margin-bottom': code ? '50px':'0'}">
        ...
        <span class="toggle" title="Open in Codepen" v-if="codepen" @click="openCodepen" :style="{'margin-bottom': code ? '100px':'50px'}">
...
.demo.full > span.toggle{
    opacity: 1;
}
.demo:hover > span.toggle:hover{
