...
Defined in: [src/gfx/renderJob/graph/passes/GPUCullPass.ts:30](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GPUCullPass.ts#L30)

GPU-driven mesh culling feature. Wraps [GPUCullSystem](GPUCullSystem.md).
...
> `readonly` **name**: `"GPUCullPass"` = `'GPUCullPass'`

Defined in: [src/gfx/renderJob/graph/passes/GPUCullPass.ts:31](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GPUCullPass.ts#L31)
...
> **get** **system**(): [`GPUCullSystem`](GPUCullSystem.md)

Defined in: [src/gfx/renderJob/graph/passes/GPUCullPass.ts:65](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GPUCullPass.ts#L65)

##### Returns

[`GPUCullSystem`](GPUCullSystem.md)
...
Defined in: [src/gfx/renderJob/graph/passes/GPUCullPass.ts:38](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GPUCullPass.ts#L38)
...
Defined in: [src/gfx/renderJob/graph/passes/GPUCullPass.ts:45](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GPUCullPass.ts#L45)
