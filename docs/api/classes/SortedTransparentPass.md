...
# Class: SortedTransparentPass

Defined in: [src/gfx/renderJob/graph/passes/SortedTransparentPass.ts:39](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SortedTransparentPass.ts#L39)
...
> **new SortedTransparentPass**(`filter?`): `SortedTransparentPass`

Defined in: [src/gfx/renderJob/graph/passes/SortedTransparentPass.ts:42](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SortedTransparentPass.ts#L42)

#### Parameters

##### filter?

[`SortedTransparentFilter`](../type-aliases/SortedTransparentFilter.md) = `'all'`
...
> `readonly` **name**: `"SortedTransparentPass"` = `'SortedTransparentPass'`

Defined in: [src/gfx/renderJob/graph/passes/SortedTransparentPass.ts:40](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SortedTransparentPass.ts#L40)
...
> `readonly` **filter**: [`SortedTransparentFilter`](../type-aliases/SortedTransparentFilter.md) = `'all'`
...
Defined in: [src/gfx/renderJob/graph/passes/SortedTransparentPass.ts:46](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SortedTransparentPass.ts#L46)
...
Defined in: [src/gfx/renderJob/graph/passes/SortedTransparentPass.ts:59](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SortedTransparentPass.ts#L59)
