...
Defined in: [src/shape/StripeGeometry.ts:11](https://github.com/orillusion/orillusion/blob/main/src/shape/StripeGeometry.ts#L11)
...
> **new StripeGeometry**(`segments`): `StripeGeometry`

Defined in: [src/shape/StripeGeometry.ts:23](https://github.com/orillusion/orillusion/blob/main/src/shape/StripeGeometry.ts#L23)
...
Defined in: [src/shape/StripeGeometry.ts:13](https://github.com/orillusion/orillusion/blob/main/src/shape/StripeGeometry.ts#L13)
