...
Defined in: [src/util/transformUtil/TransformControllerBaseComponent.ts:27](https://github.com/orillusion/orillusion/blob/main/src/util/transformUtil/TransformControllerBaseComponent.ts#L27)
