...
Defined in: [src/shape/TorusGeometry.ts:10](https://github.com/orillusion/orillusion/blob/main/src/shape/TorusGeometry.ts#L10)
...
> **new TorusGeometry**(`radius?`, `tube?`, `radialSegments?`, `tubularSegments?`): `TorusGeometry`

Defined in: [src/shape/TorusGeometry.ts:39](https://github.com/orillusion/orillusion/blob/main/src/shape/TorusGeometry.ts#L39)
...
{number} Radius of torus, default value is 0.4

##### tube?

`number` = `0.1`

{number} Pipe radius, default value is 0.1.

##### radialSegments?

`number` = `32`

{number}Number of torus segments, default value is 32.

##### tubularSegments?

`number` = `32`

{number} Number of pipeline segments, defualt value is 32.
...
Defined in: [src/shape/TorusGeometry.ts:14](https://github.com/orillusion/orillusion/blob/main/src/shape/TorusGeometry.ts#L14)
...
Defined in: [src/shape/TorusGeometry.ts:19](https://github.com/orillusion/orillusion/blob/main/src/shape/TorusGeometry.ts#L19)
...
Defined in: [src/shape/TorusGeometry.ts:24](https://github.com/orillusion/orillusion/blob/main/src/shape/TorusGeometry.ts#L24)
...
Defined in: [src/shape/TorusGeometry.ts:29](https://github.com/orillusion/orillusion/blob/main/src/shape/TorusGeometry.ts#L29)
