...
Defined in: [src/textures/HDRTexture.ts:11](https://github.com/orillusion/orillusion/blob/main/src/textures/HDRTexture.ts#L11)
...
> **new HDRTexture**(): `HDRTexture`

Defined in: [src/textures/HDRTexture.ts:13](https://github.com/orillusion/orillusion/blob/main/src/textures/HDRTexture.ts#L13)
...
Defined in: [src/textures/HDRTexture.ts:26](https://github.com/orillusion/orillusion/blob/main/src/textures/HDRTexture.ts#L26)
...
assign the texture width

##### height?

`number` = `32`

assign the texture height
...
> **load**(`url`, `loaderFunctions?`, `ctx?`): `Promise`\<`HDRTexture`\>

Defined in: [src/textures/HDRTexture.ts:84](https://github.com/orillusion/orillusion/blob/main/src/textures/HDRTexture.ts#L84)
