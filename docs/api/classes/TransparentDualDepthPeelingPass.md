...
# Class: TransparentDualDepthPeelingPass

Defined in: [src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingPass.ts:75](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingPass.ts#L75)
...
- Each transparent fragment with `oitMode === 'depth-peel'` runs
  through the DDPFrontPass pipeline (one/zero overwrite
...
- Result: per pixel, the front-most fragment wins via GPU depth-
  ...
  alpha=α, and the [TransparentDualDepthPeelingResolvePass](TransparentDualDepthPeelingResolvePass.md)
...
Coexists with [TransparentOITPass](TransparentOITPass.md) (WBOIT) — each pass
...
> **new TransparentDualDepthPeelingPass**(): `TransparentDualDepthPeelingPass`

#### Returns

`TransparentDualDepthPeelingPass`
...
> `readonly` **name**: `"TransparentDualDepthPeelingPass"` = `'TransparentDualDepthPeelingPass'`

Defined in: [src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingPass.ts:76](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingPass.ts#L76)
...
Defined in: [src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingPass.ts:85](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingPass.ts#L85)
...
Defined in: [src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingPass.ts:111](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingPass.ts#L111)
