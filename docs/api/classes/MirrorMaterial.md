...
Defined in: [src/materials/MirrorMaterial.ts:80](https://github.com/orillusion/orillusion/blob/main/src/materials/MirrorMaterial.ts#L80)

Planar-mirror material. Samples a render target (typically the
output of a [SceneCaptureCameraComponent](SceneCaptureCameraComponent.md) attached to a
...
1. Setting up a second [Camera3D](Camera3D.md) that mirrors the main camera
...
2. Attaching a [SceneCaptureCameraComponent](SceneCaptureCameraComponent.md) to that camera
...
3. Binding the resulting capture texture into this material via
   [MirrorMaterial.mirrorMap](#mirrormap) once the capture pass has run
...
> **new MirrorMaterial**(`_ctx?`): `MirrorMaterial`

Defined in: [src/materials/MirrorMaterial.ts:82](https://github.com/orillusion/orillusion/blob/main/src/materials/MirrorMaterial.ts#L82)
...
> **get** **mirrorMap**(): [`Texture`](Texture.md)

Defined in: [src/materials/MirrorMaterial.ts:103](https://github.com/orillusion/orillusion/blob/main/src/materials/MirrorMaterial.ts#L103)
...
> **set** **mirrorMap**(`texture`): `void`

Defined in: [src/materials/MirrorMaterial.ts:98](https://github.com/orillusion/orillusion/blob/main/src/materials/MirrorMaterial.ts#L98)

Capture render target sampled in screen space. Bind the texture
 produced by your mirror-camera's [SceneCaptureCameraComponent.getCaptureTexture](SceneCaptureCameraComponent.md#getcapturetexture)
...
Defined in: [src/materials/MirrorMaterial.ts:116](https://github.com/orillusion/orillusion/blob/main/src/materials/MirrorMaterial.ts#L116)
...
Defined in: [src/materials/MirrorMaterial.ts:111](https://github.com/orillusion/orillusion/blob/main/src/materials/MirrorMaterial.ts#L111)
