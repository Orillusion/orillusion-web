...
Defined in: [src/gfx/renderJob/graph/passes/HiZPass.ts:38](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/HiZPass.ts#L38)
...
so [GPUCullSystem](GPUCullSystem.md) (which still looks the texture up through
...
> `readonly` **name**: `"HiZPass"` = `'HiZPass'`

Defined in: [src/gfx/renderJob/graph/passes/HiZPass.ts:39](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/HiZPass.ts#L39)
...
Defined in: [src/gfx/renderJob/graph/passes/HiZPass.ts:59](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/HiZPass.ts#L59)
...
Defined in: [src/gfx/renderJob/graph/passes/HiZPass.ts:192](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/HiZPass.ts#L192)
