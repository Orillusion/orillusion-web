...
Defined in: [src/gfx/renderJob/graph/passes/ColorPass.ts:67](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ColorPass.ts#L67)

Main forward color pass. Single responsibility: draw the opaque half
of the scene (transmission materials excluded so the
[SceneColorPyramidPass](SceneColorPyramidPass.md) snapshot that follows sees the world
*behind* the glass, not the glass itself).

Sky is rendered separately by [SkyPass](SkyPass.md) — chain it after this
pass in the renderer job. Transparent / transmission halves
([TransmissionOpaquePass](TransmissionOpaquePass.md), [SortedTransparentPass](SortedTransparentPass.md))
...
is owned by [GBufferResourcePass](GBufferResourcePass.md). Multiple ColorPass
...
> **new ColorPass**(`config?`): `ColorPass`

Defined in: [src/gfx/renderJob/graph/passes/ColorPass.ts:80](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ColorPass.ts#L80)
...
> `readonly` **name**: `string` = `'ColorPass'`

Defined in: [src/gfx/renderJob/graph/passes/ColorPass.ts:68](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ColorPass.ts#L68)
...
Defined in: [src/gfx/renderJob/graph/passes/ColorPass.ts:85](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ColorPass.ts#L85)
...
Defined in: [src/gfx/renderJob/graph/passes/ColorPass.ts:89](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ColorPass.ts#L89)
...
Defined in: [src/gfx/renderJob/graph/passes/ColorPass.ts:138](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ColorPass.ts#L138)
