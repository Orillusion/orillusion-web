...
Defined in: [src/gfx/renderJob/graph/passes/TransparentResolvePass.ts:23](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentResolvePass.ts#L23)
...
> **new TransparentResolvePass**(): `TransparentResolvePass`
...
> `readonly` **name**: `"TransparentResolvePass"` = `'TransparentResolvePass'`

Defined in: [src/gfx/renderJob/graph/passes/TransparentResolvePass.ts:24](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentResolvePass.ts#L24)
...
Defined in: [src/gfx/renderJob/graph/passes/TransparentResolvePass.ts:31](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentResolvePass.ts#L31)
...
Defined in: [src/gfx/renderJob/graph/passes/TransparentResolvePass.ts:93](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentResolvePass.ts#L93)
