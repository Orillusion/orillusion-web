...
Defined in: [src/gfx/renderJob/graph/passes/SceneCapturePass.ts:66](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SceneCapturePass.ts#L66)

Renders every scene-registered [SceneCaptureCameraComponent](SceneCaptureCameraComponent.md)
...
Runs after [ShadowPass](ShadowPass.md) + [PointShadowPass](PointShadowPass.md) +
[ReflectionPass](ReflectionPass.md) (so captures include directional + point
shadows and the pre-filtered reflection cube), and before
[ColorPass](ColorPass.md) (so captured textures are ready when main-pass
...
Declares read dependencies on [MAIN\_SHADOW\_MAP](../variables/MAIN_SHADOW_MAP.md) and
[POINT\_SHADOW\_CUBE\_ARRAY](../variables/POINT_SHADOW_CUBE_ARRAY.md) so the validator orders this
pass after the shadow producers. The capture's lit shaders
sample those textures via GlobalBindGroup, the same
...
[SceneCaptureCameraComponent](SceneCaptureCameraComponent.md) owns its own RT (lazily
allocated through GBufferFrame), and consumer materials bind
those RTs directly via the component's
[SceneCaptureCameraComponent.getCaptureTexture](SceneCaptureCameraComponent.md#getcapturetexture). This
...
Per-component [SceneCaptureCameraComponent.captureMask](SceneCaptureCameraComponent.md#capturemask)
(allowlist) and [SceneCaptureCameraComponent.excludeMask](SceneCaptureCameraComponent.md#excludemask)
...
> **new SceneCapturePass**(): `SceneCapturePass`
...
> `readonly` **name**: `"SceneCapturePass"` = `'SceneCapturePass'`

Defined in: [src/gfx/renderJob/graph/passes/SceneCapturePass.ts:67](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SceneCapturePass.ts#L67)
...
Defined in: [src/gfx/renderJob/graph/passes/SceneCapturePass.ts:68](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SceneCapturePass.ts#L68)
...
Defined in: [src/gfx/renderJob/graph/passes/SceneCapturePass.ts:72](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SceneCapturePass.ts#L72)
...
Defined in: [src/gfx/renderJob/graph/passes/SceneCapturePass.ts:84](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SceneCapturePass.ts#L84)
