...
Defined in: [src/materials/UnLitMaterial.ts:15](https://github.com/orillusion/orillusion/blob/main/src/materials/UnLitMaterial.ts#L15)
...
- [`SoftParticleMaterial`](SoftParticleMaterial.md)

## Constructors

### Constructor

> **new UnLitMaterial**(`ctx?`): `UnLitMaterial`

Defined in: [src/materials/UnLitMaterial.ts:21](https://github.com/orillusion/orillusion/blob/main/src/materials/UnLitMaterial.ts#L21)
