...
# Class: TransparentOITPass

Defined in: [src/gfx/renderJob/graph/passes/TransparentOITPass.ts:38](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentOITPass.ts#L38)
...
culled. Companion [TransparentResolvePass](TransparentResolvePass.md) composites the
...
> **new TransparentOITPass**(): `TransparentOITPass`
...
> `readonly` **name**: `"TransparentOITPass"` = `'TransparentOITPass'`

Defined in: [src/gfx/renderJob/graph/passes/TransparentOITPass.ts:39](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentOITPass.ts#L39)
...
Defined in: [src/gfx/renderJob/graph/passes/TransparentOITPass.ts:53](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentOITPass.ts#L53)
...
Defined in: [src/gfx/renderJob/graph/passes/TransparentOITPass.ts:87](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentOITPass.ts#L87)
