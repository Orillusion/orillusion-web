...
Defined in: [src/gfx/renderJob/graph/passes/DecalShadowVolumePass.ts:77](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/DecalShadowVolumePass.ts#L77)

Projected-decal pass — composites textures from
[DecalComponent](DecalComponent.md) volumes onto the opaque scene using a
stencil shadow-volume algorithm (Carmack's Reverse / Z-fail).

Per frame, for every enabled [DecalComponent](DecalComponent.md):
...
written as a mutator. [ForwardRendererJob](ForwardRendererJob.md) inserts this pass
...
per-component uniform-buffer cache keyed by [DecalComponent](DecalComponent.md).
...
Defined in: [src/gfx/renderJob/graph/passes/DecalShadowVolumePass.ts:78](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/DecalShadowVolumePass.ts#L78)
...
Defined in: [src/gfx/renderJob/graph/passes/DecalShadowVolumePass.ts:107](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/DecalShadowVolumePass.ts#L107)
...
Defined in: [src/gfx/renderJob/graph/passes/DecalShadowVolumePass.ts:147](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/DecalShadowVolumePass.ts#L147)
...
Defined in: [src/gfx/renderJob/graph/passes/DecalShadowVolumePass.ts:154](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/DecalShadowVolumePass.ts#L154)
