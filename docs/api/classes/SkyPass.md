...
Defined in: [src/gfx/renderJob/graph/passes/SkyPass.ts:39](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SkyPass.ts#L39)
...
subclassed [ColorPass](ColorPass.md) no longer has to override
`shouldDrawSky()` to suppress a redundant sky draw, and a renderer
that wants no sky at all simply omits this pass.

Ordering: declared as a [COLOR\_BUFFER](../variables/COLOR_BUFFER.md) mutator + reader of
[TRANSPARENT\_DRAW\_CTX](../variables/TRANSPARENT_DRAW_CTX.md). The graph orders mutators after the
creator ([GBufferResourcePass](GBufferResourcePass.md)) and tie-breaks among multiple
...
[SceneColorPyramidPass](SceneColorPyramidPass.md)-style read of the color attachment).
...
When no [SkyRenderer](SkyRenderer.md) is registered in the scene, `execute`
...
> `readonly` **name**: `string` = `'SkyPass'`

Defined in: [src/gfx/renderJob/graph/passes/SkyPass.ts:40](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SkyPass.ts#L40)
...
Defined in: [src/gfx/renderJob/graph/passes/SkyPass.ts:44](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SkyPass.ts#L44)
...
Defined in: [src/gfx/renderJob/graph/passes/SkyPass.ts:58](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SkyPass.ts#L58)
