...
Defined in: [src/gfx/renderJob/graph/passes/GUIPass.ts:30](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GUIPass.ts#L30)
...
enabled — see [PostPass](PostPass.md)) and blits it to the swapchain via
...
> `readonly` **name**: `"GUIPass"` = `'GUIPass'`

Defined in: [src/gfx/renderJob/graph/passes/GUIPass.ts:31](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GUIPass.ts#L31)
...
Defined in: [src/gfx/renderJob/graph/passes/GUIPass.ts:35](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GUIPass.ts#L35)
...
Defined in: [src/gfx/renderJob/graph/passes/GUIPass.ts:44](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GUIPass.ts#L44)
...
Defined in: [src/gfx/renderJob/graph/passes/GUIPass.ts:49](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GUIPass.ts#L49)
