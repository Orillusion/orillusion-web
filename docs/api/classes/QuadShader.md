...
Defined in: [src/loader/parser/prefab/mats/shader/QuadShader.ts:14](https://github.com/orillusion/orillusion/blob/main/src/loader/parser/prefab/mats/shader/QuadShader.ts#L14)
...
> **new QuadShader**(`ctx`, `vs?`, `fs?`): `QuadShader`

Defined in: [src/loader/parser/prefab/mats/shader/QuadShader.ts:16](https://github.com/orillusion/orillusion/blob/main/src/loader/parser/prefab/mats/shader/QuadShader.ts#L16)
