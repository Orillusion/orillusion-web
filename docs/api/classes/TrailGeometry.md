...
Defined in: [src/shape/TrailGeometry.ts:11](https://github.com/orillusion/orillusion/blob/main/src/shape/TrailGeometry.ts#L11)
...
> **new TrailGeometry**(`segment`): `TrailGeometry`

Defined in: [src/shape/TrailGeometry.ts:22](https://github.com/orillusion/orillusion/blob/main/src/shape/TrailGeometry.ts#L22)
...
Defined in: [src/shape/TrailGeometry.ts:16](https://github.com/orillusion/orillusion/blob/main/src/shape/TrailGeometry.ts#L16)
