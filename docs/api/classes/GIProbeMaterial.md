...
Defined in: [src/materials/GIProbeMaterial.ts:25](https://github.com/orillusion/orillusion/blob/main/src/materials/GIProbeMaterial.ts#L25)
...
> **new GIProbeMaterial**(`type?`, `index?`, `ctx?`): `GIProbeMaterial`

Defined in: [src/materials/GIProbeMaterial.ts:28](https://github.com/orillusion/orillusion/blob/main/src/materials/GIProbeMaterial.ts#L28)

#### Parameters

##### type?

`GIProbeMaterialType` = `GIProbeMaterialType.CastGI`
...
Defined in: [src/materials/GIProbeMaterial.ts:26](https://github.com/orillusion/orillusion/blob/main/src/materials/GIProbeMaterial.ts#L26)
