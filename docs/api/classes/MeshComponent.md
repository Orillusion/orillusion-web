...
- [eventDispatcher](MeshComponent.md#eventdispatcher)
...
- [beforeDestroy](MeshComponent.md#beforedestroy)
- [copyComponent](MeshComponent.md#copycomponent)
...
▸ **copyComponent**(`from`): [`MeshComponent`](MeshComponent.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `from` | [`MeshComponent`](MeshComponent.md) |
