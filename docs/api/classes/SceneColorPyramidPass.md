...
Defined in: [src/gfx/renderJob/graph/passes/SceneColorPyramidPass.ts:51](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SceneColorPyramidPass.ts#L51)
...
so [LitMaterial.transmissionFactor](LitMaterial.md#transmissionfactor) and related callers that
...
[TextureIdentityWatcher](TextureIdentityWatcher.md) forces a mip-chain refresh when the
...
> **new SceneColorPyramidPass**(): `SceneColorPyramidPass`
...
> `readonly` **name**: `"SceneColorPyramidPass"` = `'SceneColorPyramidPass'`

Defined in: [src/gfx/renderJob/graph/passes/SceneColorPyramidPass.ts:52](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SceneColorPyramidPass.ts#L52)
...
Defined in: [src/gfx/renderJob/graph/passes/SceneColorPyramidPass.ts:58](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SceneColorPyramidPass.ts#L58)
...
Defined in: [src/gfx/renderJob/graph/passes/SceneColorPyramidPass.ts:99](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/SceneColorPyramidPass.ts#L99)
