...
# Class: ClearDepthPass

Defined in: [src/gfx/renderJob/graph/passes/ClearDepthPass.ts:54](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ClearDepthPass.ts#L54)
...
Opens a render pass on the target [RenderGraphRenderTarget](RenderGraphRenderTarget.md)
...
> **new ClearDepthPass**(`config?`): `ClearDepthPass`

Defined in: [src/gfx/renderJob/graph/passes/ClearDepthPass.ts:61](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ClearDepthPass.ts#L61)
...
Defined in: [src/gfx/renderJob/graph/passes/ClearDepthPass.ts:55](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ClearDepthPass.ts#L55)
...
Defined in: [src/gfx/renderJob/graph/passes/ClearDepthPass.ts:67](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ClearDepthPass.ts#L67)
...
Defined in: [src/gfx/renderJob/graph/passes/ClearDepthPass.ts:95](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ClearDepthPass.ts#L95)
