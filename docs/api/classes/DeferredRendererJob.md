...
# Class: DeferredRendererJob

Defined in: [src/gfx/renderJob/jobs/DeferredRendererJob.ts:15](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/jobs/DeferredRendererJob.ts#L15)

Deferred rendering job — roadmap placeholder.

The engine ships a Forward+ pipeline ([RendererJob](RendererJob.md)) as the
...
> **new DeferredRendererJob**(`_view`): `DeferredRendererJob`

Defined in: [src/gfx/renderJob/jobs/DeferredRendererJob.ts:16](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/jobs/DeferredRendererJob.ts#L16)
