...
# Class: GBufferResourcePass

Defined in: [src/gfx/renderJob/graph/passes/GBufferResourcePass.ts:59](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GBufferResourcePass.ts#L59)
...
[ColorPass](ColorPass.md) so multiple `ColorPass` instances (e.g. a GIS-style
"draw terrain → clear depth → draw world" pipeline) can coexist
without any of them having to no-op `registerSharedOutputs`.

Owns:
  - The `colorPass_GBuffer` [RTFrame](RTFrame.md) (singleton, allocated here).
  - RendererPassState for the first (clear) opaque sub-pass.
  - A second RendererPassState with loadOp='load' /
    depthLoadOp='load' for any continuation sub-pass (transparent
    half, chained second opaque half).
  - The [RenderContext](RenderContext.md) shared between halves so the WebGPU
    command encoder threads cleanly across them.

Publishes:
  - [COLOR\_BUFFER](../variables/COLOR_BUFFER.md) — the rgba16float color texture.
  - [NORMAL\_BUFFER](../variables/NORMAL_BUFFER.md) — the packed g-buffer attachment.
  - [TRANSPARENT\_DRAW\_CTX](../variables/TRANSPARENT_DRAW_CTX.md) — the [TransparentDrawContext](../interfaces/TransparentDrawContext.md)
...
> **new GBufferResourcePass**(): `GBufferResourcePass`
...
> `readonly` **name**: `string` = `'GBufferResourcePass'`

Defined in: [src/gfx/renderJob/graph/passes/GBufferResourcePass.ts:60](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GBufferResourcePass.ts#L60)
...
Defined in: [src/gfx/renderJob/graph/passes/GBufferResourcePass.ts:62](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GBufferResourcePass.ts#L62)
...
Defined in: [src/gfx/renderJob/graph/passes/GBufferResourcePass.ts:63](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GBufferResourcePass.ts#L63)
...
Defined in: [src/gfx/renderJob/graph/passes/GBufferResourcePass.ts:64](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GBufferResourcePass.ts#L64)

***

### mainColorRT

> **mainColorRT**: [`RenderGraphRenderTarget`](RenderGraphRenderTarget.md)

Defined in: [src/gfx/renderJob/graph/passes/GBufferResourcePass.ts:68](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GBufferResourcePass.ts#L68)

Typed RT handle wrapping the shared [GBufferFrame](GBufferFrame.md). Adopt
...
Defined in: [src/gfx/renderJob/graph/passes/GBufferResourcePass.ts:72](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GBufferResourcePass.ts#L72)
...
Defined in: [src/gfx/renderJob/graph/passes/GBufferResourcePass.ts:145](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/GBufferResourcePass.ts#L145)
