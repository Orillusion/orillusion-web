...
Defined in: [src/gfx/renderJob/graph/passes/ShadowPass.ts:45](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ShadowPass.ts#L45)
...
> `readonly` **name**: `"ShadowPass"` = `'ShadowPass'`

Defined in: [src/gfx/renderJob/graph/passes/ShadowPass.ts:46](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ShadowPass.ts#L46)
...
Defined in: [src/gfx/renderJob/graph/passes/ShadowPass.ts:48](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ShadowPass.ts#L48)
...
Defined in: [src/gfx/renderJob/graph/passes/ShadowPass.ts:49](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ShadowPass.ts#L49)
...
Defined in: [src/gfx/renderJob/graph/passes/ShadowPass.ts:69](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ShadowPass.ts#L69)
...
### markStaticShadowDirty()

> **markStaticShadowDirty**(`shadowIndex?`): `void`

Defined in: [src/gfx/renderJob/graph/passes/ShadowPass.ts:95](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ShadowPass.ts#L95)
...
Defined in: [src/gfx/renderJob/graph/passes/ShadowPass.ts:104](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/ShadowPass.ts#L104)
