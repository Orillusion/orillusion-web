...
Defined in: [src/gfx/graphics/webGpu/core/buffer/UniformGPUBuffer.ts:9](https://github.com/orillusion/orillusion/blob/main/src/gfx/graphics/webGpu/core/buffer/UniformGPUBuffer.ts#L9)
...
> **new UniformGPUBuffer**(`size`, `data?`): `UniformGPUBuffer`

Defined in: [src/gfx/graphics/webGpu/core/buffer/UniformGPUBuffer.ts:10](https://github.com/orillusion/orillusion/blob/main/src/gfx/graphics/webGpu/core/buffer/UniformGPUBuffer.ts#L10)
...
Defined in: [src/gfx/graphics/webGpu/core/buffer/UniformGPUBuffer.ts:16](https://github.com/orillusion/orillusion/blob/main/src/gfx/graphics/webGpu/core/buffer/UniformGPUBuffer.ts#L16)
