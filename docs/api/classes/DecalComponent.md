...
Defined in: [src/components/DecalComponent.ts:44](https://github.com/orillusion/orillusion/blob/main/src/components/DecalComponent.ts#L44)
...
When enabled, [ForwardRendererJob](ForwardRendererJob.md) inserts a
[DecalShadowVolumePass](DecalShadowVolumePass.md) between the opaque/transmission passes
...
> **new DecalComponent**(): `DecalComponent`
...
Defined in: [src/components/DecalComponent.ts:51](https://github.com/orillusion/orillusion/blob/main/src/components/DecalComponent.ts#L51)

Decal texture sampled in the composite pass. Any engine
 [Texture](Texture.md) works — load images with
 `Engine3D.res.loadTexture(url, …, 'srgb')` for a pooled
 [BitmapTexture2D](BitmapTexture2D.md), or feed a Canvas2D source via
...
Defined in: [src/components/DecalComponent.ts:54](https://github.com/orillusion/orillusion/blob/main/src/components/DecalComponent.ts#L54)
...
Defined in: [src/components/DecalComponent.ts:61](https://github.com/orillusion/orillusion/blob/main/src/components/DecalComponent.ts#L61)
...
> `static` **alignTopToward**(`obj`, `normal`): `void`

Defined in: [src/components/DecalComponent.ts:65](https://github.com/orillusion/orillusion/blob/main/src/components/DecalComponent.ts#L65)
...
Defined in: [src/components/DecalComponent.ts:72](https://github.com/orillusion/orillusion/blob/main/src/components/DecalComponent.ts#L72)
