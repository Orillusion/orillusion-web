...
# Class: TransparentDualDepthPeelingResolvePass

Defined in: [src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingResolvePass.ts:21](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingResolvePass.ts#L21)
...
with [TransparentDualDepthPeelingPass](TransparentDualDepthPeelingPass.md).

Mirrors [TransparentResolvePass](TransparentResolvePass.md)'s shape (private pipeline,
...
> **new TransparentDualDepthPeelingResolvePass**(): `TransparentDualDepthPeelingResolvePass`

#### Returns

`TransparentDualDepthPeelingResolvePass`
...
> `readonly` **name**: `"TransparentDualDepthPeelingResolvePass"` = `'TransparentDualDepthPeelingResolvePass'`

Defined in: [src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingResolvePass.ts:22](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingResolvePass.ts#L22)
...
Defined in: [src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingResolvePass.ts:29](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingResolvePass.ts#L29)
...
Defined in: [src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingResolvePass.ts:86](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/TransparentDualDepthPeelingResolvePass.ts#L86)
