...
Defined in: [src/gfx/renderJob/graph/passes/PreDepthPass.ts:43](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PreDepthPass.ts#L43)
...
> `readonly` **name**: `"PreDepthPass"` = `'PreDepthPass'`

Defined in: [src/gfx/renderJob/graph/passes/PreDepthPass.ts:44](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PreDepthPass.ts#L44)
...
Defined in: [src/gfx/renderJob/graph/passes/PreDepthPass.ts:46](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PreDepthPass.ts#L46)
...
Defined in: [src/gfx/renderJob/graph/passes/PreDepthPass.ts:55](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PreDepthPass.ts#L55)
...
Defined in: [src/gfx/renderJob/graph/passes/PreDepthPass.ts:59](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PreDepthPass.ts#L59)
...
Defined in: [src/gfx/renderJob/graph/passes/PreDepthPass.ts:105](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PreDepthPass.ts#L105)
