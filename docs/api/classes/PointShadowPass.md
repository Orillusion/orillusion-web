...
Defined in: [src/gfx/renderJob/graph/passes/PointShadowPass.ts:49](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PointShadowPass.ts#L49)
...
> **new PointShadowPass**(): `PointShadowPass`
...
> `readonly` **name**: `"PointShadowPass"` = `'PointShadowPass'`

Defined in: [src/gfx/renderJob/graph/passes/PointShadowPass.ts:50](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PointShadowPass.ts#L50)
...
Defined in: [src/gfx/renderJob/graph/passes/PointShadowPass.ts:52](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PointShadowPass.ts#L52)
...
Defined in: [src/gfx/renderJob/graph/passes/PointShadowPass.ts:53](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PointShadowPass.ts#L53)

***

### shadowSize

> `readonly` **shadowSize**: `number` = `1024`

Defined in: [src/gfx/renderJob/graph/passes/PointShadowPass.ts:54](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PointShadowPass.ts#L54)

***

### shadowPassCount

> **shadowPassCount**: `number` = `0`

Defined in: [src/gfx/renderJob/graph/passes/PointShadowPass.ts:55](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PointShadowPass.ts#L55)
...
Defined in: [src/gfx/renderJob/graph/passes/PointShadowPass.ts:61](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PointShadowPass.ts#L61)
...
Defined in: [src/gfx/renderJob/graph/passes/PointShadowPass.ts:71](https://github.com/orillusion/orillusion/blob/main/src/gfx/renderJob/graph/passes/PointShadowPass.ts#L71)
