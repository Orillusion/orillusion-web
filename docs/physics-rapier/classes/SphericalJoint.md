...
Defined in: [packages/physics-rapier/joint/SphericalJoint.ts:12](https://github.com/orillusion/orillusion/blob/main/packages/physics-rapier/joint/SphericalJoint.ts#L12)
...
- [`ConstraintBase`](ConstraintBase.md)\<`RAPIER.SphericalImpulseJoint`\>

## Constructors

### Constructor

> **new SphericalJoint**(): `SphericalJoint`
...
Defined in: [packages/physics-rapier/joint/SphericalJoint.ts:13](https://github.com/orillusion/orillusion/blob/main/packages/physics-rapier/joint/SphericalJoint.ts#L13)
...
Defined in: [packages/physics-rapier/joint/SphericalJoint.ts:14](https://github.com/orillusion/orillusion/blob/main/packages/physics-rapier/joint/SphericalJoint.ts#L14)
