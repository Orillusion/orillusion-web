...
# Abstract Class: ConstraintBase\<T\>

Defined in: [packages/physics-rapier/joint/ConstraintBase.ts:12](https://github.com/orillusion/orillusion/blob/main/packages/physics-rapier/joint/ConstraintBase.ts#L12)
...
- [`SphericalJoint`](SphericalJoint.md)
- [`GenericJoint`](GenericJoint.md)
- [`RopeJoint`](RopeJoint.md)
- [`SpringJoint`](SpringJoint.md)

## Type Parameters

### T

`T` *extends* `RAPIER.ImpulseJoint` = `RAPIER.ImpulseJoint`

## Constructors

### Constructor

> **new ConstraintBase**\<`T`\>(): `ConstraintBase`\<`T`\>
