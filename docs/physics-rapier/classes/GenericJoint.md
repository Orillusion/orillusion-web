...
Defined in: [packages/physics-rapier/joint/GenericJoint.ts:27](https://github.com/orillusion/orillusion/blob/main/packages/physics-rapier/joint/GenericJoint.ts#L27)
...
- [`ConstraintBase`](ConstraintBase.md)\<`RAPIER.GenericImpulseJoint`\>

## Constructors

### Constructor

> **new GenericJoint**(): `GenericJoint`
...
Defined in: [packages/physics-rapier/joint/GenericJoint.ts:28](https://github.com/orillusion/orillusion/blob/main/packages/physics-rapier/joint/GenericJoint.ts#L28)
...
Defined in: [packages/physics-rapier/joint/GenericJoint.ts:29](https://github.com/orillusion/orillusion/blob/main/packages/physics-rapier/joint/GenericJoint.ts#L29)
...
Defined in: [packages/physics-rapier/joint/GenericJoint.ts:30](https://github.com/orillusion/orillusion/blob/main/packages/physics-rapier/joint/GenericJoint.ts#L30)
...
Defined in: [packages/physics-rapier/joint/GenericJoint.ts:32](https://github.com/orillusion/orillusion/blob/main/packages/physics-rapier/joint/GenericJoint.ts#L32)
